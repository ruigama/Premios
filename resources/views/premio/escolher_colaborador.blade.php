    ...
    <div class="col-md-10 col-sm-12 offset-md-1">
        <div class="row">
            ...
            <div id="info-container" class="col-md-6 col-sm-12">
                ...
                <form action="/distribuicao/colaborador" method="post">
                    @csrf
                    <div class="col-md-10 col-sm-12 form-floating mb-2">
                        ...
                        <input type="hidden" id="premio" name="premio" value="{{ $premio_supervisor->premio }}">
                        <input type="hidden" id="total" name="total" value="{{ $premio_supervisor->disponivel }}">
                        ...
                        <label for="quantidade" class="py-2">Quantidades disponíveis: 
                            <strong>{{ $premio_supervisor->disponivel }}</strong>
                        </label>
                    </div>
                    <div class="col-md-10 col-sm-12 form-floating mb-2">                    
                        <select name="colaboradores" id="colaboradores" class="form-control">
                            <option value="0">Escolha uma opção</option>
                            @foreach($colaboradores as $funcionario)
