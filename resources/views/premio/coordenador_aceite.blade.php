            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item['premio'] }}</td>
                        <td class="text-center">{{ $item['quantidade_temporaria'] }}</td>
                        <td><a href="/distribuicao/coordenador/confirmar/{{ $item['id'] }}" class="btn btn-success">Confirmar</a></td>
                        <td><a href="/distribuicao/coordenador/cancelar/{{ $item['id'] }}" class="btn btn-danger">Cancelar</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
