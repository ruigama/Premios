...
<div id="premio-create-container" class="col-md-6 offset-md-3">
    <h1 class="m-3">Zerar Quantidade do Produto</h1>
    <form action="/premio/zerarContagem" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            ...
            <div class="col-md-6 form-floating mb-2">
                <input type="number" class="form-control" id="quantidade_premio" name="quantidade_premio" 
                       placeholder="Quantidade" onblur="quantidadeProduto()" value="{{ $premio->quantidade }}" disabled>            
            ...
            <div class="alert alert-danger d-flex align-items-center" role="alert">                
                <div>
                    ...
                    Se houver prêmios distribuidos serão zeradas as contagens dos produtos disponíveis!
                </div>
            </div>
